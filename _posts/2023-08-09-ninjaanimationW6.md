...
layout: post
title: Animation W4
description: Animation of Midnight Stalker
courses: { csse: {week: 6}}
type: collab
---
        ...
        window.addEventListener('load', function () {
            ...
            class Ninja {
                constructor() {
                    ...
                    this.frameX = 0;
                    this.frameY = 2;
                    this.velocityX = 0; // Initial velocity
                ...
                update() {
                    ...
                    // Loop ninja to the other side of the canvas when reaching the edge
            ...
            // Event listeners for ninja movement
            window.addEventListener("keydown", (event) => {
                switch (event.key) {
                    case "w":
                        ninja.velocityX = 0; // Disable horizontal movement when jumping
                        break;
                    case "a":
                        ninja.velocityX = -6; // Move left
                        break;
                    case "s":
                        ninja.velocityX = 0; // Disable horizontal movement when ducking
                        break;
                    case "d":
                        ninja.velocityX = 6; // Move right
                        break;
                }
            });
            
            window.addEventListener("keyup", () => {
                ninja.velocityX = 0; // Stop moving when key is released
            });
        });
    </script>
</body>
