...
layout: post
title: Snake Game
description: a game that involves snakes
courses: { csse: {week: 2} }
type: devops
---
...
<div class="container">
    ...
    <div class="container bg-secondary" style="text-align:center;">
        ...
        <div id="setting" class="py-4 text-light">
            <p>Settings Screen, press <span style="background-color: color: #000000">space</span> to go back to playing</p>
...
<script>
    (function(){
        ...
        let setWall = function(wall_value){
            ...
            if(wall === 1){screen_snake.style.borderColor = "#8a071d";}
        }
    })();
</script>
